...
- **Databricks**: Brand colors for consistency
...
- All Databricks credentials stored in environment variables
...
**Error**: Cannot find module '@/lib/types/genie'
**Solution**: Types have been reorganized to `@/src/types/`

**Error**: @layer base is used but no @tailwind base directive
**Solution**: Update to Tailwind v4 syntax (see migration guide)

### Runtime Errors

**Error**: Configuration validation failed
**Solution**: Check your `.env.local` file for all required variables

**Error**: Invalid Date in conversation sidebar
**Solution**: Ensure API returns proper timestamp format
